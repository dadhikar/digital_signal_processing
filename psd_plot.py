...
def csv_file_read(filename, a, b, c):
    ...
    return x1, x2, x3
#..............................................................................................
input_file = ['PSD_1Hz_250K.csv', 'PSD_1Hz_260K.csv', 'PSD_1Hz_270K.csv', 'PSD_1Hz_280K.csv', 'PSD_1Hz_290K.csv']
#..............................................................................................
...
v_280, psd_280, err_psd_280 = csv_file_read(input_file[3], 0, 1, 2)
v_290, psd_290, err_psd_290 = csv_file_read(input_file[4], 0, 1, 2)
...
ax.errorbar(v_280, psd_280, yerr= err_psd_280, fmt='o--', lw=0.5, color='C3', markersize=6, alpha=.8, ecolor='black', capsize=5, label='T = 280 K')
ax.errorbar(v_290, psd_290, yerr= err_psd_290, fmt='o--', lw=0.5, color='C4', markersize=6, alpha=.8, ecolor='black', capsize=5, label='T = 290 K')
...
ax.legend(loc='lower center', bbox_to_anchor=(0.72, 0.1), shadow=True, ncol=1, 
            fontsize='small')
